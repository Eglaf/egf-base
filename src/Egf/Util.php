...
class Util {
	 ...
	 * @deprecated Service/TextWithParams
	 ...
	 * @return array|null|\Exception The first accepted row of array or null otherwise. If key not found, gives back Exception. Do with it that as you want.
	 */
	public static function oneFromArrayByKey(array $aaRows, $sKey, $xVal, $bTypeCheck = FALSE) {
		foreach ($aaRows as $aRow) {
			if (array_key_exists($sKey, $aRow)) {
				...
				return new \Exception("Array does'nt have key: {$sKey}");
			}
		}
